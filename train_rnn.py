...
tf.flags.DEFINE_integer("max_epoch","10000", "maximum epochs")
tf.flags.DEFINE_float("lr","1e-3", "learning rate")
tf.flags.DEFINE_float("drop_out","0.7", "dropout in vision keep_prob rate (0,1]")
...
num_type = np.max(dbs.idxt_tr) + 1 # human provide while testing
